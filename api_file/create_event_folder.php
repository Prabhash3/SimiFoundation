...
//find parent folder 
    ...
    $sql = "CREATE TABLE folder_event_table_no_$folder_id( img_id  INT  primary key  AUTO_INCREMENT  ,img_org_name VARCHAR(150),img_new_name VARCHAR(150)  ,img_path VARCHAR(150) ,img_title VARCHAR(150),img_dicp VARCHAR(500) ) ; ";
    $result = $mysqli->query($sql);
    //  echo  $mysqli->error ;
    // echo "result1-";
    // print_r($result);
