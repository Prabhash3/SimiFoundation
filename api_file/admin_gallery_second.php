...
$title = (  trim( mysqli_real_escape_string($mysqli, $_REQUEST['f_name']))) ;
$img_id = (  trim( mysqli_real_escape_string($mysqli, ($_REQUEST['img_id'])))) ;
...
$desc = (  trim( mysqli_real_escape_string($mysqli, ($_REQUEST['f_name'])))) ;
$img_id = (  trim( mysqli_real_escape_string($mysqli, ($_REQUEST['img_id'])))) ;
