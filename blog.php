      ...
      <div class="container">
        <div class="row d-flex">
          <div class="col-md-4 d-flex ftco-animate">
              ...
              <div class="container">
              <div class='container d-flex justify-content-center mt-100'> <button type="button" class="btn btn-primary mx-auto" data-toggle="modal" data-target="#exampleModal"> Share </button> </div>
